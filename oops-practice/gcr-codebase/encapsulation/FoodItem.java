...
abstract class Items {
 ...
 public Items(String itemName, double price, int quantity) {
...
//Veg Item
class VegItem extends Items implements Discountable {
...
//Non-Veg Item
class NonVegItem extends Items implements Discountable {
